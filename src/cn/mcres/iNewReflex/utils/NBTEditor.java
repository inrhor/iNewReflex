...
public final class NBTEditor {
     ...
     * @param
     * keys to fetch; an integer after a key value indicates that it should get the nth place of
     ...
     * Should use the {@link (Object, Object, Object...)} method instead
     *
     * @param item
     * The itemstack to set
     * @param
     * keys to set, String for NBTCompound, int or null for an NBTTagList
     * @param value
     * The value to set
     * @return
        ...
        try {
            ...
            if ( count instanceof Byte && id instanceof String ) {
                ...
                if (INewReflex.getInfo().isOldMaterialVersion()) {
                    if (material.equals("minecraft:iron_shovel")) {
                        material = "minecraft:iron_spade";
                    }else if (material.equals("minecraft:diamond_shovel")) {
                        material = "minecraft:diamond_spade";
                    }
                }
